"""Classify all files under 02六爻卜筮 and emit liuyao_sources_manifest.json."""
...
from source_manifest_liuyao import build_file_manifest, validate_manifest_files

KNOWLEDGE_DIR = Path(__file__).resolve().parents[1]
ROOT = KNOWLEDGE_DIR.parents[1]
SOURCE_02 = ROOT / "数据库" / "02六爻卜筮"
MANIFEST_OUTPUT = KNOWLEDGE_DIR / "data" / "sources" / "liuyao_sources_manifest.json"
...
def main() -> int:
    ...
    parser.add_argument("--source", default=str(SOURCE_02))
